...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cache = __webpack_require__(168);
	...
	var _quiz = __webpack_require__(175);

	var _core = __webpack_require__(177);
	...
	_cache2.default.refresh();

	function main() {
	    // Elements used to activate certain features
	    var sidebar = (0, _helpers.byId)("sidebar");
	    var codeExamples = (0, _helpers.bySelector)(".highlight");
	    var spoilers = (0, _helpers.bySelector)(".spoiler");
	    var quiz = (0, _helpers.byId)("quiz-container");
	    var sidebarComponent = (0, _helpers.byId)("app-sidebar");
	    var profileComponent = (0, _helpers.byId)("profile-container");
	    ...
	    if (sidebarComponent) {
	        (0, _reactDom.render)(_react2.default.createElement(_sidebar2.default, null), sidebarComponent);
	    }

	    if (profileComponent) {
	        (0, _reactDom.render)(_react2.default.createElement(_profile2.default, null), profileComponent);
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _endpoints = __webpack_require__(171);
	...
	var StorageIdentifier = "_mah-propp-data";
	...
	var Cache = function () {
	    ...
	    _createClass(Cache, [{
	        ...
	        value: function refresh() {
	            ...
	            return (0, _isomorphicFetch2.default)(_endpoints.LOCAL_DATA_ENDPOINT).then(function (res) {
	                if (res.ok) {
	                    res.json().then(function (json) {
	                        _this.cache.answers = json.answers;
	                        _this.cache.material = json.material;
	                        _this.update();
	                    });
	                } else {
	        ...
	        key: "getAnswers",
	        value: function getAnswers(callback) {
	            var _this2 = this;
	            ...
	            return (0, _isomorphicFetch2.default)(_endpoints.LOCAL_DATA_ENDPOINT).then(function (res) {
	                if (res.ok) {
	                    res.json().then(function (json) {
	                        _this2.updateAnswers(json.answers);
	        ...
	        key: "getMaterial",
	        value: function getMaterial(callback) {
	            var _this3 = this;
	            ...
	            return (0, _isomorphicFetch2.default)(_endpoints.LOCAL_DATA_ENDPOINT).then(function (res) {
	                if (res.ok) {
	                    res.json().then(function (json) {
	                        _this3.updateMaterial(json.material);
	        ...
	        value: function getUser(code, callback) {
	            ...
	            return (0, _isomorphicFetch2.default)(_endpoints.GET_USER_ENDPOINT + ("?code=" + code)).then(function (res) {
	                if (res.ok) {
	                    res.json().then(function (json) {
	                        _this4.updateUser(json.user);
	                        callback(json.user);
	                    });
	                } else {
	                    console.log("Error", res);
	...
	exports.default = new Cache(Storage, StorageIdentifier);
...
/***/ function(module, exports) {
	...
	var baseURL = "http://146.185.170.62";

	// Endpoints for HTTP requests
	var LOCAL_DATA_ENDPOINT = exports.LOCAL_DATA_ENDPOINT = "/data.json";
	var SUBMIT_QUIZ_ENDPOINT = exports.SUBMIT_QUIZ_ENDPOINT = isLocal ? "http://127.0.0.1:5000/api/quiz" : baseURL + "/api/quiz";
	var GET_USER_ENDPOINT = exports.GET_USER_ENDPOINT = isLocal ? "http://127.0.0.1:5000/api/user" : baseURL + "/api/user";
	var CREATE_USER_ENDPOINT = exports.CREATE_USER_ENDPOINT = isLocal ? "http://127.0.0.1:5000/api/user" : baseURL + "/api/user";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pubsubJs = __webpack_require__(173);
	...
	var Login = function (_Component) {
	    ...
	    _createClass(Login, [{
	        ...
	        value: function handleSubmit(e) {
	            ...
	            _cache2.default.getUser(code, function (user) {
	                if (user instanceof Error) {
	                    _this2.setState({ message: MESSAGE.ERRCODE });
	                    return;
	                }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement("input", { ref: "code", type: "text", placeholder: "Användarkod" }),
	                _react2.default.createElement(
	                    "button",
	                    { type: "submit" },
	                    "Logga in"
	...
	var Logout = function (_Component2) {
	    _inherits(Logout, _Component2);

	    function Logout(props) {
	        _classCallCheck(this, Logout);

	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Logout).call(this, props));
	...
	var MaterialItem = function MaterialItem(m, i) {
	    return _react2.default.createElement(
	        "li",
	        { key: i },
	        _react2.default.createElement(
	            "a",
	            { href: "/material/" + m.id + ".html" },
	            m.name
	        )
	    );
	};
	var MaterialList = function MaterialList(_ref) {
	...
	var Sidebar = function (_Component3) {
	    ...
	    function Sidebar(props) {
	        ...
	        _this4.state = {
	            user: _cache2.default.user,
	            loggedin: _cache2.default.userExists(),
	            visible: true
	        };
	        // Re-bind methods
	        _this4.loginUser = _this4.loginUser.bind(_this4);
	        _this4.listenToUserLogin = _this4.listenToUserLogin.bind(_this4);
	        _this4.logoutUser = _this4.logoutUser.bind(_this4);
	        _this4.toggleVisible = _this4.toggleVisible.bind(_this4);
	        _this4.updateUser = _this4.updateUser.bind(_this4);

	        _pubsubJs2.default.subscribe("user.quiz.done", _this4.updateUser);
	        _pubsubJs2.default.subscribe("user.login", _this4.listenToUserLogin);
	        return _this4;
	    }
	    ...
	    _createClass(Sidebar, [{
	        ...
	        key: "listenToUserLogin",
	        value: function listenToUserLogin(u) {
	            this.setState({
	                user: u,
	                loggedin: true
	            });
	        ...
	        value: function logoutUser() {
	            ...
	            _cache2.default.updateUser(null);
	        ...
	        value: function render() {
	            ...
	            if (!this.state.loggedin) {
	                return _react2.default.createElement(Login, { loginHandler: this.loginUser });
	            }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(MaterialList, { items: _cache2.default.material }),
	                _react2.default.createElement(Logout, { logoutHandler: this.logoutUser })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegistrationForm = function RegistrationForm(_ref) {
	    ...
	    var submit = function submit(e) {
	        ...
	        return (0, _isomorphicFetch2.default)(_endpoints.CREATE_USER_ENDPOINT, payload).then(function (res) {
	            if (res.ok) {
	                res.json().then(function (json) {
	                    if (json.exists) {
	                    ...
	                    if (json.hasOwnProperty('user')) {
	                        setMessage("");
	                        _cache2.default.updateUser(json.user);
	                        _pubsubJs2.default.publish("user.login", json.user);
	                    }
	                });
	            } else {
	                setMessage("");
	    ...
	    return _react2.default.createElement(
	        "div",
	        { className: "actions registration-form" },
	        _react2.default.createElement(
	            "h5",
	            null,
	            "Registrera dig eller logga in för att visa din profil"
	        ),
	        _react2.default.createElement(
	            "form",
	            { onSubmit: submit },
	...
	var Profile = function (_Component2) {
	    ...
	    function Profile(props) {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Profile).call(this, props));
	        ...
	        // Re-bind methods
	        _this2.loginUser = _this2.loginUser.bind(_this2);
	        _this2.logoutUser = _this2.logoutUser.bind(_this2);
	        _this2.setMessage = _this2.setMessage.bind(_this2);
	        _this2.fetchAnswers = _this2.fetchAnswers.bind(_this2);
	        // Subscribe to events
	        _pubsubJs2.default.subscribe("user.login", _this2.loginUser);
	        _pubsubJs2.default.subscribe("user.logout", _this2.logoutUser);
	        return _this2;
	    }
	    ...
	    _createClass(Profile, [{
	        ...
	        value: function fetchAnswers() {
	            ...
	            _cache2.default.getAnswers(function (a) {
	                return _this3.setState({ answers: a });
	            });
	        }
	    }, {
	        key: "loginUser",
	        ...
	        value: function render() {
	            if (!this.state.user) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(RegistrationForm, { setMessage: this.setMessage })
	                );
	            }
	            ...
	            return _react2.default.createElement(
	                "div",
	                { className: "user-profile" },
	                _react2.default.createElement(UserStats, { user: this.state.user })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function convertAlternatives(list, index) {
	    ...
	    var div = (0, _helpers.create)("div");
	    var alpha = "abcdefghj".split("");

	    div.id = "answer-" + index;

	    // Creates a <input> alternative
	    function createAlternative(li, i) {
	        var label = (0, _helpers.create)("label");
	        var input = (0, _helpers.create)("input");
	    ...
	    (0, _helpers.shuffle)((0, _helpers.toArray)(list.children).map(createAlternative)).map(function (label) {
	...
	function serializeFormData(target) {
	    return (0, _helpers.toArray)(target)
	...
	function submitQuiz(e) {
	    ...
	    var quizMessage = (0, _helpers.byId)("quiz-message");
	    var quizId = (0, _helpers.byId)("quiz-id").value;
	    var materialId = (0, _helpers.byId)("material-id").value;

	    // Can't submit quiz if you're not logged in
	    if (!_cache2.default.userExists()) {
	    ...
	    var currQuizAnswers = _cache2.default.answers.filter(function (a) {
	        return a.id == quizId;
	    })[0];
	    ...
	    var allCorrectAnswers = correctAnswers == currQuizAnswers.answers.length;
	    ...
	    // Quiz payload
	    var payload = {
	        id: _cache2.default.user.id,
	        code: _cache2.default.user.code,
	        quiz: quizId,
	        material: materialId,
	        answers: formData,
	    ...
	    return sendQuizResults(payload);
	}
	...
	function sendQuizResults(payload, done) {
	    ...
	    return (0, _isomorphicFetch2.default)(_endpoints2.default, init).then(function (res) {
	        if (res.ok) {
	            res.json().then(function (json) {
	                _cache2.default.updateUser(json.user);
	                showQuizCompleteMessage(payload.done);
	            });
	        } else {
	            console.log("Error", res);
	        }
	...
	function showQuizCompletionMessage(done) {
	    var submitBtn = (0, _helpers.byId)("submit-quiz"),
	        materialId = (0, _helpers.byId)("material-id").value,
	        a = (0, _helpers.create)("a");
	...
	function setupQuiz() {
	    // Elements
	    var quizContainer = (0, _helpers.byId)("quiz-container");
	    var quizForm = (0, _helpers.byId)("quiz-form");
	    var materialId = (0, _helpers.byId)("material-id").value;
	    var questionHeaders = (0, _helpers.bySelector)("#quiz-container h3");
	    var alternativeLists = (0, _helpers.bySelector)("#quiz-container .alternatives");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setSidebar() {
	    var sidebar = (0, _helpers.byId)("sidebar");
	    var header = (0, _helpers.byId)("header");
	    var sidebarButton = (0, _helpers.byId)("toggle-sidebar");
	    var courseElms = (0, _helpers.bySelector)(".course-overview-element");
	    var anchors = (0, _helpers.bySelector)("#sidebar ul ul a");
	...
	function highlightNavigation() {
	    var anchors = (0, _helpers.bySelector)(".navigation li a");
	...
	function createLineNumberButton() {
	    var btn = (0, _helpers.create)("button");
	    var txt = document.createTextNode("radnummer");
	    var show = (0, _helpers.create)("span");
	    var hide = (0, _helpers.create)("span");
